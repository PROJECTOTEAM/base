...
fanart     = xbmc.translatePath(os.path.join('https://i62.servimg.com/u/f62/19/44/91/43/fanart12.jpg' + addon_id , 'fanart.jpg'))
logfile    = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'log.txt'))

def home():
	
	addDir('[COLOR white]Android IPTV[/COLOR]','url',4000,'https://i62.servimg.com/u/f62/19/44/91/43/icon11.png',fanart,'')	
