...
def cat():
	addDir('[COLOR lime][B]FREETVIP[/COLOR][/B]','freetvvip',3,'https://cdn6.aptoide.com/imgs/a/7/8/a78c34966c4e443e7235d839b5856c0d_icon.png?w=256',fanart,'')
	#addDir('[COLOR lime][B]IPTV4SAT[/COLOR][/B]','iptv4sat',3,'https://cdn6.aptoide.com/imgs/a/7/8/a78c34966c4e443e7235d839b5856c0d_icon.png?w=256',fanart,'')
	addDir('[COLOR lime][B]IPTVFILMOVER[/COLOR][/B]','iptvfilmmover',3,'https://cdn6.aptoide.com/imgs/a/7/8/a78c34966c4e443e7235d839b5856c0d_icon.png?w=256',fanart,'')
	addDir('[COLOR lime][B]IPTVSATLINKS[/COLOR][/B]','iptvsattlinks',3,'https://cdn6.aptoide.com/imgs/a/7/8/a78c34966c4e443e7235d839b5856c0d_icon.png?w=256',fanart,'')
	addDir('[COLOR lime][B]PANDA TV[/COLOR][/B]','panda',3,'https://cdn6.aptoide.com/imgs/a/7/8/a78c34966c4e443e7235d839b5856c0d_icon.png?w=256',fanart,'')
	addDir('[COLOR lime][B]SOURCETV[/COLOR][/B]','sourceetv',3,'https://cdn6.aptoide.com/imgs/a/7/8/a78c34966c4e443e7235d839b5856c0d_icon.png?w=256',fanart,'')
...
def iptv4sat():
	...
	dest = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.module.livetv/downloads/', 'iptv4sat.zip'))
	...
	for a in dir:
		if a.endswith('.m3u'):
			...
			os.remove(xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.module.livetv/downloads/',a)))
...
def iptvfilmover(url):
	...
	for a in all:
		...
		addDir('[B][COLOR lime]%s[/COLOR][/B]'%name,url,3,icon,fanart,'')
	try:
