...
SOURCES = [{"title": "script.module.vod.tvsupertuga.addon ", "url": "aHR0cDovL3RlYW10dWdhNGV2ZXIubmV0MjMubmV0Ly1iYXNlNjQvY21jdmMyMWtZbUZ6ZGpocUwyWmhibUZ5ZEM1cWNHYzhMMlpoYm1GeWRENEtQQzlwZEdWdFBnb2dDZ29LSUFvZ0NpQUtJQW84TDJsMFpXMXpQZz09LnhtbA==", "fanart": "http://www.technobuffalo.com/wp-content/uploads/2016/02/tim-peake-photos-003.jpg", "genre": "IPTV TELEVISION", "date": "10.17.2015", "credits": "script.module.vod.tvsupertuga.addon", "thumbnail": "http://i86.servimg.com/u/f86/19/44/91/43/icon10.png"}]
...
Q1RWQmFzZQ0K = base64.b64decode('aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3VWYW43dEJN')



def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.script.module.vod.tvsupertuga.addon Lists-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(script.module.vod.tvsupertuga.addon,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(script.module.vod.tvsupertuga.addon,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
