...
addon_id            = 'script.module.docstvsupertuga.addon'
AddonTitle          = '[COLOR white]WORLD DOCUMENTARIES[/COLOR]'
...
def GetMenu():
    ...
    addLink('[COLOR white][B]RANDOM DOCUMENTARY[/B][/COLOR]',base64.b64decode(b'aHR0cHM6Ly9kb2N1bWVudGFyeXN0b3JtLmNvbS8/cmFuZG9t'),902,icon,fanarts,'Watch a random documentary!')
    addDir('[COLOR white][B]SEARCH[/B][/COLOR]','url',998,icon,fanarts,'Search through all of our supported websites for a documentary of your choice!')
    addDir('[COLOR white][B]##################################################[/B][/COLOR]','url',999,icon,fanarts,'')	
	
    addDir('[COLOR greenyellow]CRIME DOCUMENTARIES[/COLOR]',base64.b64decode(b'aHR0cDovL2NyaW1lZG9jdW1lbnRhcnkuY29t'),33,icon,fanarts,'')
    #addDir('[COLOR greenyellow]DOCUMENTARY ADDICTS[/COLOR]',base64.b64decode(b'aHR0cDovL3RvcGRvY3VtZW50YXJ5ZmlsbXMuY29tLw=='),30,icon,fanarts,'Now part of 5,341 documentaries online and counting! Welcome to the largest and best curated collection of documentaries on the planet.')
    addDir('[COLOR greenyellow]DOCUMENTARY HEAVEN[/COLOR]',base64.b64decode(b'aHR0cDovL2RvY3VtZW50YXJ5aGVhdmVuLmNvbQ=='),19,icon,fanarts,'DocumentaryHeaven.com personally will only collect visitor information when our commenting system is used. This includes a users  IP address and e-mail address via our commenting system. This is only used to help us improve our site, and to prevent abuse of our commenting system DocumentaryHeaven.com will under no circumstances disclose any information collected unless required to do so by law or court order. Our visitors privacy is paramount to us!')
    addDir('[COLOR greenyellow]DOCUMENTARY LOVERS[/COLOR]',base64.b64decode(b'aHR0cDovL2RvY3VtZW50YXJ5bG92ZXJzLmNvbQ=='),14,icon,fanarts,'We are a curated movie catalog bringing you the best and most intriguing documentaries free to watch online from any device. Our list consists of short and full-length films, educational talks and video previews that you can sort by topic to pique your curiosity.')
    addDir('[COLOR greenyellow]DOCUMENTARIES STORM[/COLOR]',base64.b64decode(b'aHR0cHM6Ly9kb2N1bWVudGFyeXN0b3JtLmNvbQ=='),9,icon,fanarts,'Welcome to DocumentaryStorm, the leading source for 100% free documentary films. We curate the best documentary films available online for educational purposes as well as personal enjoyment.')
    addDir('[COLOR greenyellow]DOCUMENTARY TUBE[/COLOR]',base64.b64decode(b'aHR0cDovL3d3dy5kb2N1bWVudGFyeXR1YmUuY29t'),24,icon,fanarts,"We're committed to providing the best documentaries from around the World. With hundreds of free documentaries published and categorised every month, there's something for every taste.")   
    #addDir('[COLOR greenyellow]Free Documentaries[/COLOR]',base64.b64decode(b'aHR0cHM6Ly9mcmVlZG9jdW1lbnRhcmllcy5vcmc='),6,icon,fanarts,'Freedocumentaries.org streams full-length documentary films free of charge, with no registration needed. For several films, we even offer the ability to watch trailers or to download the actual film.')
    addDir('[COLOR greenyellow]SNAGFILMS[/COLOR]',base64.b64decode(b'aHR0cDovL3d3dy5zbmFnZmlsbXMuY29tL21vdmllcy9kb2N1bWVudGFyeQ=='),17,icon,fanarts,'SnagFilms is like that cool local video store with unique indie films and exciting hidden movie treasures except everything can be watched online! For those of us looking to discover something different, SnagFilms has over 5,000 movies, TV show episodes, eye-opening documentaries and exclusive original comedy shorts. There is something to watch for everyone!')
    addDir('[COLOR greenyellow]SPORTS DOCUMENTARIES[/COLOR]',base64.b64decode(b'aHR0cDovL3Nwb3J0c2RvY3VtZW50YXJpZXMuY29t'),28,icon,fanarts,"Find all of the latest sports documentaries streaming online for free. Every week we add more sports related documentary videos so that you can watch videos about your favourite players or sports. Part of our dedication to keeping up this video site is offering as many of the tv series specials as possible. Some of those include ESPN's E60, 30 for 30, A Football Life, and more.")
    addDir('[COLOR greenyellow]TOP DOCUMENTARIES[/COLOR]',base64.b64decode(b'aHR0cDovL3d3dy50b3Bkb2N1bWVudGFyeWZpbG1zLmNvbQ=='),1,icon,fanarts,'View a wide selection of documentaries from Top Documentaries!')

def Top_Documentaries_Main(name,url,iconimage):

    link = open_url(url)
    addDir('[COLOR greenyellow]Catagories[/COLOR]',base64.b64decode(b'aHR0cDovL3d3dy50b3Bkb2N1bWVudGFyeWZpbG1zLmNvbQ=='),5,icon,fanarts,'Browse through all the catagories on Top Documentaries!')
    url = re.compile('<a class="browse" href="(.+?)">.+?</a>').findall(link)[0]
    addDir('[COLOR greenyellow]Browse[/COLOR]',url,2,icon,fanarts,'Browse the documentaries on Top Documentaries!')
    url = re.compile('<a class="list" href="(.+?)">.+?</a>').findall(link)[0]
    addDir('[COLOR greenyellow]List[/COLOR]',url,4,icon,fanarts,'List the documentaries on Top Documentaries!')
    url = re.compile('<a class="top-100" href="(.+?)">.+?</a>').findall(link)[0]
    addDir('[COLOR greenyellow]Top 100[/COLOR]',url,3,icon,fanarts,'View the top 100 documentaries on Top Documentaries!')
...
def Top_Documentaries_Browse(name,url,iconimage):
    ...
    for items in match:
        ...
        addLink('[COLOR greenyellow]' + name + ' | Rating: [COLOR yellowgreen]' + rating + '[/COLOR] - Year: [COLOR yellowgreen]' + year +'[/COLOR][/COLOR]',url,900,iconimage,fanarts,desc)
...
def Free_Documentaries_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,8,icon,fanarts,"")
    link = open_url(url).replace('\n','').replace('\r','')
...
def Documentary_Storm_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,8,icon,fanarts,"")
    addDir('[COLOR greenyellow]Catagories[/COLOR]',base64.b64decode(b'aHR0cHM6Ly9kb2N1bWVudGFyeXN0b3JtLmNvbQ=='),10,icon,fanarts,"")
    link = open_url(url).replace('\n','').replace('\r','')
    ...
    for item in match2:
        ...
        if "full-documentary-list" in url:
            addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,12,icon,fanarts,'')
        elif "?random" in url:
            addLink('[COLOR greenyellow]' + name + '[/COLOR]',url,902,icon,fanarts,'')
        else:
            addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,11,icon,fanarts,'')
...
def Documentary_Storm_Cats(name,url,iconimage):
    ...
    for item in match:
        ...
        for url,desc,name in each:
            addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,11,icon,fanarts,desc)
...
def Documentary_Storm_Browse(name,url,iconimage):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        addLink('[COLOR greenyellow]' + name + ' | Runtime: [COLOR yellowgreen]' + min + '[/COLOR] - Year: [COLOR yellowgreen]' + year + '[/COLOR] - Rating: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]',url,902,iconimage,fanarts,desc)
...
def Search_Documentary_Storm():
    ...
    for item in match:
        ...
        name = Cleaner(name)
        name = '[COLOR greenyellow]' + name + ' | Runtime: [COLOR yellowgreen]' + min + '[/COLOR] - Year: [COLOR yellowgreen]' + year + '[/COLOR] - Rating: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]'
        namelist.append(name)
        urllist.append(url)
        iconlist.append(iconimage)
        desclist.append(desc)
...
def Documentary_Lovers_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,16,icon,fanarts,"")
    link = open_url(url).replace('\n','').replace('\r','')
        ...
        try:
            ...
            if "/" in url:
                if name.lower() not in str(blacklist):
                    ...
                    name = Cleaner(name)
                    addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,15,icon,fanarts,'')
        except: pass
...
def Documentary_Lovers_Browse(name,url,iconimage):
    ...
    if "top-films" in url:
        for item in match:
            ...
            name = Cleaner(name)
            addLink('[COLOR yellowgreen]Rank: ' + rank + '[/COLOR][COLOR greenyellow] - ' + name + ' - Stars: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]',url,903,iconimage,fanarts,desc)
    else:    
        for item in match:
            if "/film" in url:
            ...
            name = Cleaner(name)
            addLink('[COLOR greenyellow]' + name + ' | Runtime: [COLOR yellowgreen]' + min + '[/COLOR] - Stars: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]',url,903,iconimage,fanarts,desc)
...
def Search_Documentary_Lovers():
    ...
    for item in match:
        ...
        name = Cleaner(name)
        name = '[COLOR greenyellow]' + name + ' | Runtime: [COLOR yellowgreen]' + min + '[/COLOR] - Stars: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]'
...
def SnagFilms_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,18,icon,fanarts,"")
    link = open_url(url).replace('\n','').replace('\r','')
    ...
    for item in match:
        try:
            ...
            if not '{' in year:
                addLink('[COLOR greenyellow]' + name + ' | Year: [COLOR yellowgreen]' + year + '[/COLOR][/COLOR]',url,904,iconimage,fanarts,desc)
        except: pass
...
def Search_SnagFilms():
    ...
    for entry in json_data['results']:
        ...
        name = '[COLOR greenyellow]' + str(name) + ' | Year: [COLOR yellowgreen]' + str(year) + '[/COLOR][/COLOR]'
        namelist.append(name)
        urllist.append(url)
        iconlist.append(iconimage)
        desclist.append(desc)
...
def Documentary_Heaven_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,23,icon,fanarts,"")
    link = open_url(url).replace('\n','').replace('\r','')
    ...
    for url,name in match:
        if name.lower() not in str(blacklist):
            ...
            if "watch-online" in url:
                addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,21,icon,fanarts,'')
            elif "popular" in url:
                addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,22,icon,fanarts,'')
            else:
                addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,20,icon,fanarts,'')
...
def Documentary_Heaven_Browse(name,url,iconimage):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        addLink('[COLOR greenyellow]' + name + ' - Rating:[COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]',url,905,iconimage,fanarts,desc)
...
def Documentary_Heaven_Top100(name,url,iconimage):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        addLink('[COLOR yellowgreen]Rank: ' + rank + '[/COLOR] | [COLOR greenyellow]' + name + '[/COLOR]',url,905,iconimage,fanarts,desc)
...
def Search_Documentary_Heaven():
    ...
    for items in match:
        ...
        if not "category" in url:
            name = '[COLOR greenyellow]' + str(name) + ' | Rating: [COLOR yellowgreen]' + str(rating) + '[/COLOR][/COLOR]'
            namelist.append(name)
            urllist.append(url)
            iconlist.append(iconimage)
            desclist.append(desc)
...
def Documentary_Tube_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,27,icon,fanarts,"")
    link = open_url(url).replace('\n','').replace('\r','')
    ...
    for items in match2:
        ...
        if name.lower() not in str(blacklist):
            name = Cleaner(name)
            addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,25,icon,fanarts,'')
...
def Documentary_Tube_Browse(name,url,iconimage):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        addLink('[COLOR greenyellow]' + name + ' [COLOR yellowgreen](' + upload + ')[/COLOR] -  | Runtime: [COLOR yellowgreen]' + time + '[/COLOR] Rating: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]',url,906,iconimage,fanarts,desc)
...
def Search_Documentary_Tube(url):
    ...
    for items in match:
        ...
        if "videos/" in url:
            name = '[COLOR greenyellow]' + str(name) + '[/COLOR]'
            namelist.append(name)
            urllist.append(url)
            iconlist.append(iconimage)
            desclist.append(desc)
...
def Sports_Documentaries_Main(name,url,iconimage):
    ...
    for items in match:
        ...
        name = Cleaner(name)
        addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,29,icon,fanarts,'')
...
def Sports_Documentaries_Browse(name,url,iconimage):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        addLink('[COLOR greenyellow]' + name + '[/COLOR]',url,907,iconimage,fanarts,desc)
...
def Documentary_Addicts_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,32,icon,fanarts,"")
    ...
    for items in match:
        ...
        url = re.compile('href="(.+?)">').findall(items)[0]
        name = Cleaner(name)
        addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,31,icon,fanarts,'')
...
def Documentary_Addicts_Browse(name,url,iconimage):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        addLink('[COLOR greenyellow]' + name + ' | Rating: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]',url,908,iconimage,fanarts,desc)
...
def Search_Documentary_Addicts(url):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        name = '[COLOR greenyellow]' + name + ' | Rating: [COLOR yellowgreen]' + rating + '[/COLOR][/COLOR]'
        namelist.append(name)
        urllist.append(url)
        iconlist.append(iconimage)
        desclist.append(desc)
...
def Crime_Documentaries_Main(name,url,iconimage):
    ...
    addDir('[COLOR white]Search...[/COLOR]',url,39,icon,fanarts,"")
    addDir('[COLOR greenyellow]Featured Documentary[/COLOR]',url,34,icon,fanarts,"")
    addDir('[COLOR greenyellow]Popular This Week[/COLOR]',base64.b64decode(b'aHR0cDovL2NyaW1lZG9jdW1lbnRhcnkuY29tL3dwLWFkbWluL2FkbWluLWFqYXgucGhwP2FjdGlvbj13cHBfZ2V0X3BvcHVsYXImaWQ9Mw=='),34,icon,fanarts,"")
    addDir('[COLOR greenyellow]Popular All Time[/COLOR]',base64.b64decode(b'aHR0cDovL2NyaW1lZG9jdW1lbnRhcnkuY29tL3dwLWFkbWluL2FkbWluLWFqYXgucGhwP2FjdGlvbj13cHBfZ2V0X3BvcHVsYXImaWQ9NA=='),34,icon,fanarts,"")
    addDir('[COLOR greenyellow]Browse All[/COLOR]',base64.b64decode(b'aHR0cDovL2NyaW1lZG9jdW1lbnRhcnkuY29tL2Jyb3dzZS1hbGw='),36,icon,fanarts,"")
    addDir('[COLOR greenyellow]Categories[/COLOR]',url,34,icon,fanarts,"")
    addDir('[COLOR greenyellow]Shows[/COLOR]',url,35,icon,fanarts,"")
...
def Crime_Documentaries_Categories(name,url,iconimage):
    ...
    if "Featured Documentary" in name:
        ...
        for item in match:
            ...
            iconimage = re.compile('src="(.+?)"').findall(item)[0]
            name = Cleaner(name)
            addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,38,iconimage,fanarts,"")
        ...
        for item in match:
            ...
            url = re.compile('<a href="(.+?)">.+?</a>').findall(item)[0]
            name = Cleaner(name)
            addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,37,iconimage,fanarts,"")
...
def Crime_Documentaries_Browse(name,url,iconimage):
    ...
    for item in match:
        ...
        desc = re.compile('<p>(.+?)</p>').findall(item)[0]
        name = Cleaner(name)
        addDir('[COLOR greenyellow]' + name + '[/COLOR]',url,38,iconimage,fanarts,desc)
...
def Crime_Documentaries_List_Eps(name,url,iconimage):
    ...
    try:
        ...
        for item in match:
            ...
            got = 1
            if not "imdb" in imdb:
                addLink('[COLOR greenyellow]' + name + '[/COLOR]',url,909,iconimage,fanarts,desc)
            else:
                addLink('[COLOR greenyellow]' + name + ' - [/COLOR][COLOR yellowgreen]' + imdb + '[/COLOR]',url,909,iconimage,fanarts,desc)
    except: pass
...
def Search_Crime_Documentaries(url):
    ...
    for item in match:
        ...
        name = Cleaner(name)
        name = '[COLOR greenyellow]' + name + '[/COLOR]'
        namelist.append(name)
        urllist.append(url)
        iconlist.append(iconimage)
        desclist.append(desc)
...
def Multi_Search():
    ...
    dp.create(AddonTitle, '[COLOR greenyellow]Searching for ' + string.title())
    dp.update(0)
    ...
    try:
        ...
        for item in match:
            ...
            name = '[COLOR greenyellow]' + name + ' - Year: ' + year + ' | [COLOR yellowgreen]Source: Free Documentaries[/COLOR]'
            namelist.append(name)
            urllist.append(url)
            iconlist.append(iconimage)
            desclist.append(desc)
    ...
    if not dp.iscanceled(): 
        ...
        try:
            ...
            for item in match:
                ...
                name = Cleaner(name)
                name = '[COLOR greenyellow]' + name + ' - Year: ' + year + ' | [COLOR yellowgreen]Source: Documentary Storm[/COLOR]'
    ...
    if not dp.iscanceled(): 
        ...
        try:
            ...
            for item in match:
                ...
                name = Cleaner(name)
                name = '[COLOR greenyellow]' + name + ' - Year: Unknown | [COLOR yellowgreen]Source: Documentary Lovers[/COLOR]'
    ...
    if not dp.iscanceled(): 
        ...
        try:
            ...
            for entry in json_data['results']:
                ...
                name = Cleaner(name)
                name = '[COLOR greenyellow]' + name + ' - Year: ' + str(year) + ' | [COLOR yellowgreen]Source: SnagFilms[/COLOR]'
    ...
    if not dp.iscanceled(): 
        ...
        try:
            ...
            for items in match:
                ...
                if not "category" in url:
                    name = '[COLOR greenyellow]' + name + ' - Rating: ' + str(rating) + ' | [COLOR yellowgreen]Source: Documentary Heaven[/COLOR]'
    ...
    if not dp.iscanceled(): 
        ...
        try:
            ...
            for items in match:
                ...
                if "videos/" in url:
                    name = '[COLOR greenyellow]' + name + ' | [COLOR yellowgreen]Source: Documentary Tube[/COLOR]'
    ...
    if not dp.iscanceled(): 
        ...
        try:
            for item in match:
                ...
                name = Cleaner(name)
                name = '[COLOR greenyellow]' + name + ' - Rating: ' + str(rating) + ' | [COLOR yellowgreen]Source: Documentary Addicts[/COLOR]'
                namelist.append(name)
                urllist.append(url)
                iconlist.append(iconimage)
                desclist.append(desc)
    ...
    if not dp.iscanceled(): 
        ...
        try:
            ...
            for item in match:
                ...
                name = Cleaner(name)
                name = '[COLOR greenyellow]' + name + '[/COLOR] | [COLOR yellowgreen]Source: Crime Documentaries[/COLOR]'
                namelist.append(name)
                urllist.append(url)
                iconlist.append(iconimage)
                desclist.append(desc)
    ...
    addLink("[COLOR greenyellow]-----------------------------------------------------[/COLOR]",'url',999,icon,fanarts,'')
