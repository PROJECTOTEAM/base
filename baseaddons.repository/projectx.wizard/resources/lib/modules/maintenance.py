...
EXCLUDES     = ['projectx.wizard','repository.echocoder','script.module.requests','temp','kodi.log','kodi.log.old','spmc.log','spmc.log.old','dbmc.log','dbmc.log.old']
...
def AUTO_CLEAN_ON_OFF():
    ...
    HOME         =  xbmc.translatePath('special://userdata/addon_data/projectx.wizard')
