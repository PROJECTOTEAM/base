...
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'projectx.wizard')
...
addon_id = 'projectx.wizard'
ADDON = xbmcaddon.Addon(id=addon_id)
AddonID='projectx.wizard'
...
EXCLUDES       = ['cache','temp','tmp_trakt','EXCLUDES','Database','backupdir','projectx.wizard','script.module.requests','repository.echo']
EXCLUDES_BUILD = ['Thumbnails','cache','temp','tmp_trakt','EXCLUDES','Database','backupdir','projectx.wizard','script.module.requests','repository.echo']
EXCLUDES_FILES = ""
ARTPATH      =  '' + os.sep
...
zip = 'special://home/addons/projectx.wizard'
urlbase      =  'None'
maincopy   =  ADDON.getSetting('maincopy')
dialog = xbmcgui.Dialog()
urlupdate =  ""
