...
ADDON     =  xbmc.translatePath(os.path.join('special://home/addons/projectx.wizard',''))
...
if os.path.exists(ECHO_VERSION):
	...
	FIND_URL = BASEURL + base64.b64decode(b'YXhkZXNhL3dpemFyZC9tYXN0ZXIvcHJvamVjdHh3aXphcmQzL0ZJTkRfVVJMLnR4dA==')
	checkurl = BASEURL + base64.b64decode(b'YXhkZXNhL3dpemFyZC9tYXN0ZXIvcHJvamVjdHh3aXphcmQzL2NoZWNrdXJsLnR4dA==')
	pleasecheck = 1
