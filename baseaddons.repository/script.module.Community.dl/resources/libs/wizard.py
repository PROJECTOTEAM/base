...
def add_one(build_name):
	try:
		service_url = 'http://soapt.pe.hu/Api/api.php?action=add&name=' + base64.b64encode(build_name)
...
def count_total(build_name):
	try:
		service_url = 'http://soapt.pe.hu/Api/api.php?action=count&name=' + base64.b64encode(build_name)
