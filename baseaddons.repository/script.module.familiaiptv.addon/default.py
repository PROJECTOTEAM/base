...
SOURCES = [{"title": "script.module.familiaiptv.addon ", "url": "http://bit.ly/29ojshgsgbsfhbfkjbbgjskbgjbsgjjhgbdjvbd6653735r3hfhbf", "fanart": "http://www.technobuffalo.com/wp-content/uploads/2016/02/tim-peake-photos-003.jpg", "genre": "IPTV TELEVISION", "date": "10.17.2015", "credits": "script.module.familiaiptv.addon", "thumbnail": "http://i86.servimg.com/u/f86/19/44/91/43/icon10.png"}]
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.script.module.familiaiptv.addon Lists-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(script.module.familiaiptv.addon,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(script.module.familiaiptv.addon,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
