...
#            data = get_rottentomatoes_movies("dvds/upcoming"), "UpcomingDVDs"
        #  The MovieDB
            ...
            if params.get("type"):
                if params.get("type") == "movie": path = xbmc.translatePath("special://profile/addon_data/script.vodextende/simple_selector_movies.txt")
                elif params.get("type") == "tv": path = xbmc.translatePath("special://profile/addon_data/script.vodextende/simple_selector_tvshows.txt")
                else: return
        ...
        # ACTIONS
            ...
            if xbmc.getCondVisibility("Container.Content(movies)"):
                xbmc.executebuiltin("RunScript(script.vodextende,info=extendedinfo,dbid=%s,id=%s)" % (dbid, xbmc.getInfoLabel("ListItem.Property(id)")))
            elif xbmc.getCondVisibility("Container.Content(tvshows)"):
                xbmc.executebuiltin("RunScript(script.vodextende,info=extendedtvinfo,dbid=%s,id=%s)" % (dbid, xbmc.getInfoLabel("ListItem.Property(id)")))
            elif xbmc.getCondVisibility("Container.Content(seasons)"):
                xbmc.executebuiltin("RunScript(script.vodextende,info=seasoninfo,tvshow=%s,season=%s)" % (xbmc.getInfoLabel("ListItem.TVShowTitle"), xbmc.getInfoLabel("ListItem.Season")))
            elif xbmc.getCondVisibility("Container.Content(actors) | Container.Content(directors)"):
                xbmc.executebuiltin("RunScript(script.vodextende,info=extendedactorinfo,name=%s)" % (xbmc.getInfoLabel("ListItem.Label")))
        elif info == "ratedialog":
            resolve_url(params.get("handle"))
            if xbmc.getCondVisibility("Container.Content(movies)"):
                xbmc.executebuiltin("RunScript(script.vodextende,info=ratemedia,type=movie,dbid=%s,id=%s)" % (xbmc.getInfoLabel("ListItem.DBID"), xbmc.getInfoLabel("ListItem.Property(id)")))
            elif xbmc.getCondVisibility("Container.Content(tvshows)"):
                xbmc.executebuiltin("RunScript(script.vodextende,info=ratemedia,type=tv,dbid=%s,id=%s)" % (xbmc.getInfoLabel("ListItem.DBID"), xbmc.getInfoLabel("ListItem.Property(id)")))
            elif xbmc.getCondVisibility("Container.Content(episodes)"):
                xbmc.executebuiltin("RunScript(script.vodextende,info=ratemedia,type=episode,tvshow=%s,season=%s)" % (xbmc.getInfoLabel("ListItem.TVShowTitle"), xbmc.getInfoLabel("ListItem.Season")))
                ...
                if params.get("query", ""):
                    if params.get("query", "") == "qqqqq":
                        if params.get("type", "") == "movie":
                            ...
                            xbmc.executebuiltin("Notification(Please set a valid type,and try again, 5000, special://home/addons/script.vodextende/icon.png)")
                            return
                    else:
                    ...
                    if params.get("iquery", "") == "qqqqq":
                        ...
                        if params.get("type", "") == "movie":
                            ...
                            xbmc.executebuiltin('Container.Refresh')
                    if params.get("type", "") == "movie":
                        xbmc.executebuiltin('ReplaceWindow(10025,plugin://plugin.program.super.favourites/?label=MovieSearch&mode=400&path=special://home/addons/script.vodextende/resources/extras/movie/)')
                        xbmc.executebuiltin("Dialog.Close(all,true)")
                    elif params.get("type", "") == "tv":
                        xbmc.executebuiltin('ReplaceWindow(10025,plugin://plugin.program.super.favourites/?label=ShowSearch&mode=400&path=special://home/addons/script.vodextende/resources/extras/tv/)')
                        xbmc.executebuiltin("Dialog.Close(all,true)")
                    else:
                        xbmc.executebuiltin('ReplaceWindow(10025,plugin://plugin.program.super.favourites/?label=TotalSearch&mode=400&path=special://home/addons/script.vodextende/resources/extras/total/)')
                        xbmc.executebuiltin("Dialog.Close(all,true)")
                else:
