...
for path in unique:
    ...
    for file in thumbnails:
        ...
        thumbs[file] = thumb
logo_folder = 'special://profile/addon_data/script.tvsupertugaguide/addon_logos/'
for addonId in sorted(logos):
    folder = 'special://profile/addon_data/script.tvsupertugaguide/addon_logos/%s' % addonId
...
dialog.notification("TVsupertuga TV Guide","Done: Download Logos")
