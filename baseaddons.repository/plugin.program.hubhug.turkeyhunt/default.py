...
class MyWindow(xbmcgui.Window):
	...
	Txt1="               [COLOR mediumpurple][I]Shoot only the[/I]  [B]TURKEYS![/B][/COLOR][CR]"; 
	Txt2='               '+cFL('Ducks: %s','red')+cFL('        Non-Ducks: %s','yellow')+'     '
	duckPosY =190; NonDuckPosY =100; wDuck =80; hDuck=108; wNonDuck =200; hNonDuck =200; 
	duckPosY2=460; NonDuckPosY2=410; wDuck2=53; hDuck2=80; wNonDuck2=186; hNonDuck2=155; 
	duckPosY3=620; NonDuckPosY3=590; wDuck3=68; hDuck3=70; wNonDuck3=200; hNonDuck3=110; 
	SleepSpeed=30; 
	...
	def __init__(self):
		...
		self.GameArt=[]
		## top
		self.GameArt.append([artp('run_turkey3_right'),artp('Planet_Venus'),artj('hit_turkey3'),'gun-gunshot-01',artp('miss_turkey3'),'gun-gunshot-02']); 
		## middle
		self.GameArt.append([artp('run_turkey1'),artp('basket1'),artj('hit_turkey2'),'gun-gunshot-01',artp('miss_turkey2'),'gun-gunshot-02']); 
		## bottom
		self.GameArt.append([artp('run_turkey2_left'),artp('alligator_right'),artp('hit_turkey1'),'gun-gunshot-01',artp('FishingFunny'),'gun-gunshot-02']); 
