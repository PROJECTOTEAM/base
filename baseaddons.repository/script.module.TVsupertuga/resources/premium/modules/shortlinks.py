...
dir= xbmc.translatePath('special://home/addons/plugin.video.TVsupertuga/resources/modules/')
...
def popupd(announce):
	...
	class TextBox():
		...
		def setControls(self):
			self.win.getControl(self.CONTROL_LABEL).setLabel('[COLOR cyan]TV[/COLOR]-[COLOR red]supertuga[/COLOR]') # set heading
